    ...
    return Object.keys(items)
      .reduce(
        (accumulator, productId) =>
          products.find((prod) => prod.id.toString() === productId.toString())
            .price *
            items[productId] +
          accumulator,
        0,
    ...
    <>
      ...
      <div className="ShoppingCart Card">
        ...
        {shoppingCart.getQuantityAll() === 0 && (
          <div className="ShoppingCart__placeholder">
      ...
      {shoppingCart.getQuantityAll() !== 0 && (
        <div className="ShoppingCart__checkout-container">
          ...
          <Button
            className="ShoppingCart__checkout-button Button--secondary"
      ...
      <Modal ref={modalRef}>
        This web shop is a prototype for demonstration purposes. There&apos;s no
        checkout and the demo ends here.
      </Modal>
    </>
  );
}
