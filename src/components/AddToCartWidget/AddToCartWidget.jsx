...
function AddToCartWidget({product}) {
    ...
    return <div className="AddToCartWidget">
        <label htmlFor={product.id.toString()} className="for">Quantity:</label>
        <input
            ...
            min="1"
            value={numberInput}/>
        <Button className="Button--secondary" onClick={handleAddToCart}>Add to Cart</Button>
        {addedToCartHistory.map((element, index) => <p className="AddToCartWidget__success-message" key={index}>
